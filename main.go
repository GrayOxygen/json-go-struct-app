		...
		MenuOptions: []*astilectron.MenuItemOptions{
			...
			},
			{
				...
				SubMenu: []*astilectron.MenuItemOptions{
					...
					{Role: astilectron.MenuItemRoleStartSpeaking},
					{Role: astilectron.MenuItemRoleStopSpeaking},
					{Role: astilectron.MenuItemRoleFront},
					{Role: astilectron.MenuItemRoleZoom},
					{Role: astilectron.MenuItemRoleWindow},
